        ...
        <div className="container mx-auto px-6 md:px-12 max-w-3xl">
          ...
          <div className="space-y-8 text-muted-foreground leading-relaxed">
            <div>
              ...
              <p>
                Оператором персональных данных является ИП Ручин А.А. (ОГРН 314547617800293, далее — «Оператор»). Обработка персональных данных осуществляется в соответствии с Федеральным законом № 152-ФЗ «О персональных данных».
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Пользователь вправе в любое время отозвать своё согласие на обработку персональных данных, направив письменное заявление на адрес: <a href="mailto:ukmoscow@inbox.ru" className="text-foreground underline underline-offset-4">ukmoscow@inbox.ru</a>. После получения отзыва Оператор прекращает обработку данных и удаляет их в течение 30 дней.
              </p>
            </div>
