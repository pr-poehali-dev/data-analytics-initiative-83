...
const faqs = [
  ...
  {
    question: "Что входит в управление арендными квартирами?",
    answer:
      "Мы берём на себя весь цикл: поиск и проверку жильцов, заключение договоров, контроль своевременной оплаты, решение бытовых и технических вопросов, организацию уборки и мелкого ремонта. Вы получаете ежемесячные отчёты и доход — без лишних хлопот.",
  },
  {
    question: "Нужно ли мне присутствовать при заселении или выселении жильцов?",
    answer:
      "Нет. Мы полностью берём на себя все этапы: показ квартиры, подписание документов, передачу ключей, приёмку объекта при выезде. Ваше участие минимально — вы только согласовываете кандидатуру жильца, если хотите.",
  },
  {
    question: "Как быстро вы находите жильцов?",
    answer:
      "В среднем мы закрываем вакансию за 7–14 дней. Размещаем объявления на всех ключевых площадках, проводим показы и проверяем платёжеспособность кандидатов, чтобы минимизировать простой квартиры.",
  },
]
